...
#define COLOR_STATUS_WAIT (Clay_Color){220, 180, 70, 255}
#define COLOR_STATUS_ERR (Clay_Color){200, 80, 80, 255}
#define COLOR_STATUS_DONE (Clay_Color){80, 150, 230, 255}
#define COLOR_SIDEBAR_ACTIVE (Clay_Color){42, 44, 56, 255}
