...
To offer argument completions (`/docs topic`), add a `pico_add_completer` — see `completers.md`. The builtin command completer already knows `/model`, `/effort`, `/login`, `/logout`, `/docs`.
